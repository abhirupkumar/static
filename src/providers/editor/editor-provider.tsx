...
const editorReducer = (
    ...
    switch (action.type) {
        ...
        case 'SET_SITEPAGE_ID':
            const { sitePageId } = action.payload
            const updatedEditorStateWithSitePageId = {
                ...state.editor,
                sitePageId,
            }

            const updatedHistoryWithSitePageId = [
                ...state.history.history.slice(0, state.history.currentIndex + 1),
                { ...updatedEditorStateWithSitePageId }, // Save a copy of the updated state
            ]

            const sitePageIdState = {
                ...state,
                editor: updatedEditorStateWithSitePageId,
                history: {
                    ...state.history,
                    history: updatedHistoryWithSitePageId,
                    currentIndex: updatedHistoryWithSitePageId.length - 1,
                },
            }
            return sitePageIdState
